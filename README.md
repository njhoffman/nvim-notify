...
- **Neovim 0.9.0+** (tested against 0.9.5, 0.10.2, and nightly)
- Make sure to use a font which supports glyphs (icons), fonts can be found [here](https://github.com/ryanoasis/nerd-fonts)
